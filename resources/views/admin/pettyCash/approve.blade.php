                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @can('petty_cash_approve')
                                    <a class="btn btn-xs btn-success" href="{{ route('admin.petty-cash.approve', $pettyCash->id) }}">
                                    Approve
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="{{ route('admin.petty-cash.reject', $pettyCash->id) }}">
                                    Reject
                                    </a>
                                @endcan
                            </td>
